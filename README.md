...
Visit [https://nihilne.github.io/task-tracker](https://nihilne.github.io/task-tracker/) to access the task-tracker frontend. The webpage will attempt to communicate with localhost:8080 to access the API and its local database that is created automatically when first running `app.py`.
